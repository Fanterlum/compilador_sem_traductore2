...
//Clase que contiene los tipos de simbolos que se pueden reconocer
//y los valores que se le asignan a cada uno de ellos
class TipoSimbolo{
      public:
...
//Clase que contiene los estados del automata
//y los valores que se le asignan a cada uno de ellos
class Lexico{
